...
static ssize_t pmic8xxx_debounce_show(struct device *dev,
	struct device_attribute *attr, char *buf)
{
	return sprintf(buf, "pmic8xxx\n");
}

static DEVICE_ATTR(debounce_us, 0664, pmic8xxx_debounce_show, pmic8xxx_debounce_store);
